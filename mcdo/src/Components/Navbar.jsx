        ...
        >
          ...
          <Spacer />
            <Box flexGrow={2} px="20px">
              <Box m="auto" alignItems="center" display="flex" position="sticky" top="160px" gap={1}><Input borderRadius="10px" size={{ xs: "xs", sm: "sm", md: "md", lg: "lg" }} borderColor="#FFC72C" border="2px solid #FFC72C" bg="white" value={inp}  focusBorderColor="#FFC72C" onChange={ handleSearch}
            placeholder="Search" />
            ...
            <Flex gap={8} alignItems="center">
              ...
              <Link to="/cart">
                <Flex alignItems="center" gap={0}>
                  <Image
                    width="50px"
                    src="https://www.svgrepo.com/show/437968/paper-bag.svg"
                  />
